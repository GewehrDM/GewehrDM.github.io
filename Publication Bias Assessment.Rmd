...
2.  [**Y-axis:**]{.underline} the ***standard error*** of the observed effect sizes of studies. Typically, the y-axis is inverted in funnel plots, so higher positions on the plot correspond to lower standard errors, indicating more precise estimates.
...
![](images/Screenshot 2025-01-03 at 18.24.27.png)
